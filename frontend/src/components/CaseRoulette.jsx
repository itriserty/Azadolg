...
const TIERS_META = [
  {
    ...
    prizes:   [
      { win: 0,    label: '0 Кармы',    emoji: '💀', rarity: 'Пусто',     weight: 15, tag: 'zero'       },
      { win: 250,  label: '+250 Кармы', emoji: '🪙', rarity: 'Кэшбек',    weight: 30, tag: 'cashback'   },
      { win: 500,  label: '+500 Кармы', emoji: '✅', rarity: 'Выход в 0', weight: 35, tag: 'break_even' },
      { win: 1000, label: '+1000 Кармы',emoji: '💎', rarity: 'Удвоение',  weight: 12, tag: 'double'      },
      { win: 2500, label: '+2500 Кармы',emoji: '🏆', rarity: 'ДЖЕКПОТ',   weight:  8, tag: 'jackpot'    },
    ],
  },
  {
    cost:     100,
    ...
    prizes:   [
      { win: 0,   label: '0 Кармы',   emoji: '💀', rarity: 'Пусто',     weight: 15, tag: 'zero'       },
      { win: 50,  label: '+50 Кармы',  emoji: '🪙', rarity: 'Кэшбек',    weight: 30, tag: 'cashback'   },
      { win: 100, label: '+100 Кармы', emoji: '✅', rarity: 'Выход в 0', weight: 35, tag: 'break_even' },
      { win: 200, label: '+200 Кармы', emoji: '💎', rarity: 'Удвоение',  weight: 12, tag: 'double'      },
      { win: 500, label: '+500 Кармы', emoji: '🏆', rarity: 'ДЖЕКПОТ',   weight:  8, tag: 'jackpot'    },
    ],
  },
  {
    cost:     50,
    ...
    prizes:   [
      { win: 0,   label: '0 Кармы',   emoji: '💀', rarity: 'Пусто',     weight: 15, tag: 'zero'       },
      { win: 25,  label: '+25 Кармы',  emoji: '🪙', rarity: 'Кэшбек',    weight: 30, tag: 'cashback'   },
      { win: 50,  label: '+50 Кармы',  emoji: '✅', rarity: 'Выход в 0', weight: 35, tag: 'break_even' },
      { win: 100, label: '+100 Кармы', emoji: '💎', rarity: 'Удвоение',  weight: 12, tag: 'double'      },
      { win: 250, label: '+250 Кармы', emoji: '🏆', rarity: 'ДЖЕКПОТ',   weight:  8, tag: 'jackpot'    },
    ],
  },
  {
    cost:     25,
    ...
    prizes:   [
      { win: 0,   label: '0 Кармы',   emoji: '💀', rarity: 'Пусто',     weight: 15, tag: 'zero'       },
      { win: 15,  label: '+15 Кармы',  emoji: '🪙', rarity: 'Кэшбек',    weight: 30, tag: 'cashback'   },
      { win: 25,  label: '+25 Кармы',  emoji: '✅', rarity: 'Выход в 0', weight: 35, tag: 'break_even' },
      { win: 50,  label: '+50 Кармы',  emoji: '💎', rarity: 'Удвоение',  weight: 12, tag: 'double'      },
      { win: 100, label: '+100 Кармы', emoji: '🏆', rarity: 'ДЖЕКПОТ',   weight:  8, tag: 'jackpot'    },
    ],
  },
];
